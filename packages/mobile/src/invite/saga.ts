import { getAttestationFee } from '@celo/contractkit/src/attestations'
import { getAttestationsContract, getStableTokenContract } from '@celo/contractkit/src/contracts'
