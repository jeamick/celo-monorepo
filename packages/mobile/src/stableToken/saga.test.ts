...
const { getStableTokenContract } = require('@celo/contractkit/src/contracts')
const { getErc20Balance } = require('@celo/contractkit/src/erc20-utils')
