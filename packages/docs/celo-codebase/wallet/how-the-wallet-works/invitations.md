...
{% hint style="info" %}
Note: The invitation fee allows for invitees to be able to pay for verification fees and complete the [verification](verification) process upon redemption of the invitation code.  
{% endhint %}
...
- Bob is then prompted to the [verification](verification) screen.
