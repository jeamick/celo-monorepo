        ...
        <Cell span={Spans.three4th} style={[standardStyles.centered]}>
          ...
          <Fade delay={DELAY} duration={DURATION}>
            <View style={styles.buttons}>
              <View style={[standardStyles.elementalMarginTop, styles.button]}>
                <Button
              ...
              <View style={[standardStyles.elementalMargin, styles.button]}>
                ...
                <View style={[standardStyles.elementalMargin]}>
                  <Text style={[fonts.h5, textStyles.invert, textStyles.center]}>
                    Create an account with the Celo Client
                  </Text>
                </View>
              </View>
            </View>
